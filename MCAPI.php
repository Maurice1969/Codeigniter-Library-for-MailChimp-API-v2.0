...
class MCAPI {
     ...
     *
     * @param $config
     * @internal param string $apikey Your MailChimp apikey
     * @internal param string $secure Whether or not this should use a secure connection
     */
    ...
    function campaignsContent($cid, $options = NULL) {
        ...
        return $this->callServer("campaigns/content", $params);
    }
     ...
     */
    function campaignsCreate($type, $options, $content, $segment_opts=NULL, $type_opts=NULL) {
        $params = array();
        $params["type"] = $type;
        $params["options"] = $options;
        ...
        return $this->callServer("campaigns/create", $params);
    }
     ...
     */
    function campaignsDelete($cid) {
        $params = array();
        $params["cid"] = $cid;
        return $this->callServer("campaigns/delete", $params);
    }
    ...
    function campaignsList($filters=array (
        ...
        return $this->callServer("campaigns/list", $params);
    }
     ...
     */
    function campaignsPause($cid) {
        $params = array();
        $params["cid"] = $cid;
        return $this->callServer("campaigns/pause", $params);
    }
     ...
     * @param $cid
     * @return the matching campaign's details - will return same data as single campaign from campaigns/list()
     */
    function campaignsReady($cid) {
        $params = array();
        $params["cid"] = $cid;
        return $this->callServer("campaigns/ready", $params);
    }
     ...
     */
    function campaignsReplicate($cid) {
        $params = array();
        $params["cid"] = $cid;
        return $this->callServer("campaigns/replicate", $params);
    }
     ...
     * @return boolean true on success
     */
    function campaignsResume($cid) {
        $params = array();
        $params["cid"] = $cid;
        return $this->callServer("campaigns/resume", $params);
    }
    ...
    function campaignsScheduleBatch($cid, $schedule_time, $num_batches = 2, $stagger_mins = 5)
    {
        $params = array();
        $params["cid"] = $cid;
        ...
        return $this->callServer("campaigns/schedule-batch", $params);
     ...
     * @return boolean true on success
     */
    function campaignsSchedule($cid, $schedule_time, $schedule_time_b=NULL) {
        $params = array();
        $params["cid"] = $cid;
        $params["schedule_time"] = $schedule_time;
        $params["schedule_time_b"] = $schedule_time_b;
        return $this->callServer("campaigns/schedule", $params);
    }
     ...
     */
    function campaignsSegmentTest($list_id, $options) {
        $params = array();
        $params["list_id"] = $list_id;
        $params["options"] = $options;
        return $this->callServer("campaigns/segment-test", $params);
    }
     ...
     * @return boolean true on success
     */
    function campaignsSend($cid) {
        $params = array();
        $params["cid"] = $cid;
        return $this->callServer("campaigns/send", $params);
    }
     ...
     * @return boolean true on success
     */
    function campaignsSendTest($cid, $test_emails=array (
    ), $send_type=NULL) {
        $params = array();
        $params["cid"] = $cid;
        $params["test_emails"] = $test_emails;
        $params["send_type"] = $send_type;
        return $this->callServer("campaigns/send-test", $params);
    }
     ...
     */
    function campaignsTemplateContent($cid) {
        $params = array();
        $params["cid"] = $cid;
        return $this->callServer("campaigns/template-content", $params);
    }
     ...
     * @return boolean true on success
     */
    function campaignsUnschedule($cid) {
        $params = array();
        $params["cid"] = $cid;
        return $this->callServer("campaigns/unschedule", $params);
    }
     ...
     */
    function campaignsUpdate($cid, $name, $value) {
        $params = array();
        $params["cid"] = $cid;
        $params["name"] = $name;
        $params["value"] = $value;
        return $this->callServer("campaigns/update", $params);
    }
    ...
    function ecommOrderAdd($order) {
        $params = array();
        $params["order"] = $order;
        return $this->callServer("ecomm/order-add", $params);
    }
    ...
    function ecommOrderDel($store_id, $order_id) {
        ...
        return $this->callServer("ecomm/order-del", $params);
    }
    ...
    function ecommOrders($start=0, $limit=100, $since=NULL) {
        ...
        $params["limit"] = $limit;
        $params["since"] = $since;
        return $this->callServer("ecomm/orders", $params);
    }
     ...
     */
    function foldersAdd($name, $type='campaign') {
        $params = array();
        $params["name"] = $name;
        $params["type"] = $type;
        return $this->callServer("folders/add", $params);
    }
     ...
     */
    function foldersDel($fid, $type='campaign') {
        $params = array();
        $params["fid"] = $fid;
        $params["type"] = $type;
        return $this->callServer("folders/del", $params);
    }
     ...
     */
    function foldersList($type='campaign') {
        $params = array();
        $params["type"] = $type;
        return $this->callServer("folders/list", $params);
    }
     ...
     */
    function foldersUpdate($fid, $name, $type='campaign') {
        $params = array();
        $params["fid"] = $fid;
        $params["name"] = $name;
        $params["type"] = $type;
        return $this->callServer("folders/update", $params);
    }
    ...
    function galleryList($opts = NULL){
        $params = array();
        $params["opts"] = $opts;
        return $this->callServer("gallery/list", $params);
    }
     ...
     */
    function listsAbuseReports($id, $start=0, $limit=500, $since=NULL) {
        $params = array();
        $params["id"] = $id;
        $params["start"] = $start;
        $params["limit"] = $limit;
        $params["since"] = $since;
        return $this->callServer("lists/abuse-reports", $params);
    }
     ...
     */
    function listsActivity($id) {
        $params = array();
        $params["id"] = $id;
        return $this->callServer("lists/activity", $params);
    }
     ...
     */
    function listsBatchSubscribe($id, $batch, $double_optin=true, $update_existing=false, $replace_interests=true) {
        $params = array();
        $params["id"] = $id;
        $params["batch"] = $batch;
        ...
        return $this->callServer("lists/batch-subscribe", $params);
    }
     ...
     */
    function listsBatchUnsubscribe($id, $batch, $delete_member=false, $send_goodbye=true, $send_notify=false) {
        $params = array();
        $params["id"] = $id;
        $params["batch"] = $batch;
        ...
        return $this->callServer("lists/batch-unsubscribe", $params);
    }
    ...
    array clients a record containing the 'client', an 'icon' image url, the 'percent' using the client, and the total 'members' represented
     */
    function listsClients($id) {
        $params = array();
        $params["id"] = $id;
        return $this->callServer("lists/clients", $params);
    }
     ...
     */
    function listsGrowthHistory($id) {
        $params = array();
        $params["id"] = $id;
        return $this->callServer("lists/growth-history", $params);
    }
     ...
     */
    function listsInterestGroupAdd($id, $group_name, $grouping_id=NULL) {
        $params = array();
        $params["id"] = $id;
        $params["group_name"] = $group_name;
        $params["grouping_id"] = $grouping_id;
        return $this->callServer("lists/interest-group-add", $params);
    }
     ...
     * @return bool true if the request succeeds, otherwise an error will be thrown
     */
    function listsInterestGroupDel($id, $group_name, $grouping_id=NULL) {
        $params = array();
        $params["id"] = $id;
        $params["group_name"] = $group_name;
        $params["grouping_id"] = $grouping_id;
        return $this->callServer("lists/interest-group-del", $params);
    }
     ...
     * @return bool true if the request succeeds, otherwise an error will be thrown
     */
    function listsInterestGroupUpdate($id, $old_name, $new_name, $grouping_id=NULL) {
        $params = array();
        $params["id"] = $id;
        $params["old_name"] = $old_name;
        $params["new_name"] = $new_name;
        $params["grouping_id"] = $grouping_id;
        return $this->callServer("lists/interest-group-update", $params);
    }
     ...
     */
    function listsInterestGroupingAdd($id, $name, $type, $groups) {
        $params = array();
        $params["id"] = $id;
        $params["name"] = $name;
        $params["type"] = $type;
        $params["groups"] = $groups;
        return $this->callServer("lists/interest-grouping-add", $params);
    }
     ...
     * @return bool true if the request succeeds, otherwise an error will be thrown
     */
    function listsInterestGroupingDel($grouping_id) {
        $params = array();
        $params["grouping_id"] = $grouping_id;
        return $this->callServer("lists/interest-grouping-del", $params);
    }
     ...
     * @return bool true if the request succeeds, otherwise an error will be thrown
     */
    function listsInterestGroupingUpdate($grouping_id, $name, $value) {
        $params = array();
        $params["grouping_id"] = $grouping_id;
        $params["name"] = $name;
        $params["value"] = $value;
        return $this->callServer("lists/interest-grouping-update", $params);
    }
     ...
     */
    function listsInterestGroupings($id, $counts = false) {
        $params = array();
        $params["id"] = $id;
        $params["counts"] = $counts;
        return $this->callServer("lists/interest-groupings", $params);
    }
     ...
     */
    function listsList($filters=array (
     ...
     */
    function listsLocations($id) {
        $params = array();
        $params["id"] = $id;
        return $this->callServer("lists/locations", $params);
    }
     ...
     */
    function listsMemberActivity($id, $emails = array()) {
        $params = array();
        $params["id"] = $id;
        $params["emails"] = $emails;
        return $this->callServer("lists/member-activity", $params);
    }
     ...
     */
    function listsMemberInfo($id, $emails) {
        $params = array();
        $params["id"] = $id;
        $params["emails"] = $emails;
        return $this->callServer("lists/member-info", $params);
    }
    ...
    function listsMembers($id, $status='subscribed', $opts = NULL) {
        ...
        $params["opts"] = $opts;
        return $this->callServer("lists/members", $params);
    }
     ...
     * @return bool true if the request succeeds, otherwise an error will be thrown
     */
    function listsMergeVarAdd($id, $tag, $name, $options=array (
    )) {
        $params = array();
        $params["id"] = $id;
        $params["tag"] = $tag;
        $params["name"] = $name;
        $params["options"] = $options;
        return $this->callServer("lists/merge-var-add", $params);
    }
     ...
     * @return bool true if the request succeeds, otherwise an error will be thrown
     */
    function listsMergeVarDel($id, $tag) {
        $params = array();
        $params["id"] = $id;
        $params["tag"] = $tag;
        return $this->callServer("lists/merge-var-del", $params);
    }
    ...
    function listsMergeVarReset($id, $tag) {
        $params = array();
        $params["id"] = $id;
        $params["tag"] = $tag;
        return $this->callServer("lists/merge-var-reset", $params);
    }
    ...
    function listsMergeVarSet($id, $tag, $value) {
        $params = array();
        $params["id"] = $id;
        $params["tag"] = $tag;
        $params["value"] = $value;
        return $this->callServer("lists/merge-var-set", $params);
    }
     ...
     * @return bool true if the request succeeds, otherwise an error will be thrown
     */
    function listsMergeVarUpdate($id, $tag, $options) {
        $params = array();
        $params["id"] = $id;
        $params["tag"] = $tag;
        $params["options"] = $options;
        return $this->callServer("lists/merge-var-update", $params);
    }
     ...
     */
    function listsMergeVars($id) {
        $params = array();
        $params["id"] = $id;
        return $this->callServer("lists/merge-vars", $params);
    }
     ...
     */
    function listsStaticSegmentAdd($id, $name) {
        $params = array();
        $params["id"] = $id;
        $params["name"] = $name;
        return $this->callServer("lists/static-segment-add", $params);
    }
     ...
     */
    function listsStaticSegmentDel($id, $seg_id) {
        $params = array();
        $params["id"] = $id;
        $params["seg_id"] = $seg_id;
        return $this->callServer("lists/static-segment-del", $params);
    }
     ...
     */
    function listsStaticSegmentMembersAdd($id, $seg_id, $batch) {
        $params = array();
        $params["id"] = $id;
        $params["seg_id"] = $seg_id;
        $params["batch"] = $batch;
        return $this->callServer("lists/static-segment-members-add", $params);
    }
     ...
     */
    function listsStaticSegmentMembersDel($id, $seg_id, $batch) {
        $params = array();
        $params["id"] = $id;
        $params["seg_id"] = $seg_id;
        $params["batch"] = $batch;
        return $this->callServer("lists/static-segment-members-del", $params);
    }
     ...
     * @return bool true if it worked, otherwise an error is thrown.
     */
    function listsStaticSegmentReset($id, $seg_id) {
        $params = array();
        $params["id"] = $id;
        $params["seg_id"] = $seg_id;
        return $this->callServer("lists/static-segment-reset", $params);
    }
     ...
     */
    function listsStaticSegments($id) {
        $params = array();
        $params["id"] = $id;
        return $this->callServer("lists/static-segments", $params);
    }
     ...
     */
    function listsSubscribe($id, $email, $merge_vars=NULL, $email_type='html', $double_optin=true, $update_existing=false, $replace_interests=true, $send_welcome=false) {
        $params = array();
        $params["id"] = $id;
        $params["email"] = $email;
        ...
        return $this->callServer("lists/subscribe", $params);
    }
     ...
     * @return boolean true on success, false on failure. When using MCAPI.class.php, the value can be tested and error messages pulled from the MCAPI object (see below)
     */
    function listsUnsubscribe($id, $email, $delete_member=false, $send_goodbye=true, $send_notify=true) {
        $params = array();
        $params["id"] = $id;
        $params["email"] = $email;
        $params["delete_member"] = $delete_member;
        $params["send_goodbye"] = $send_goodbye;
        $params["send_notify"] = $send_notify;
        return $this->callServer("lists/unsubscribe", $params);
    }
     ...
     */
    function listsUpdateMember($id, $email, $merge_vars, $email_type='', $replace_interests=true) {
        $params = array();
        $params["id"] = $id;
        $params["email"] = $email;
        $params["merge_vars"] = $merge_vars;
        $params["email_type"] = $email_type;
        $params["replace_interests"] = $replace_interests;
        return $this->callServer("lists/update-member", $params);
    }
     ...
     */
    function listsWebhookAdd($id, $url, $actions=array (
    ), $sources=array (
    )) {
        $params = array();
        $params["id"] = $id;
        ...
        return $this->callServer("lists/webhook-add", $params);
    }
     ...
     */
    function listsWebhookDel($id, $url) {
        $params = array();
        $params["id"] = $id;
        $params["url"] = $url;
        return $this->callServer("lists/webhook-del", $params);
    }
     ...
     */
    function listsWebhooks($id) {
        $params = array();
        $params["id"] = $id;
        return $this->callServer("lists/webhooks", $params);
    }
     ...
     */
    function helperAccountDetails($exclude = array()) {
        $params = array();
        $params["exclude"] = $exclude;
        return $this->callServer("helper/account-details", $params);
    }
     ...
     */
    function helperCampaignsForEmail($email, $options) {
        $params = array();
        $params["email"] = $email;
        $params["options"] = $options;
        return $this->callServer("helper/campaigns-for-email", $params);
    }
     ...
     */
    function helperChimpChatter() {
        $params = array();
        return $this->callServer("helper/chimp-chatter", $params);
    }
     ...
     */
    function helperGenerateText($type, $content) {
        $params = array();
        $params["type"] = $type;
        $params["content"] = $content;
        return $this->callServer("helper/generate-text", $params);
    }
     ...
     */
    function helperInlineCss($html, $strip_css=false) {
        $params = array();
        $params["html"] = $html;
        $params["strip_css"] = $strip_css;
        return $this->callServer("helper/inline-css", $params);
    }
     ...
     */
    function helperListsForEmail($email) {
        $params = array();
        $params["email"] = $email;
        return $this->callServer("helper/lists-for-email", $params);
    }
    ...
    function helperPing() {
        $params = array();
        return $this->callServer("helper/ping", $params);
    }


    function helperSearchCampaigns($query, $offset, $snip_start = NULL, $snip_end = NULL) {
        $params = array();
        $params["query"] = $query;
        $params["offset"] = $offset;
        $params["snip_start"] = $snip_start;
        $params["snip_end"] = $snip_end;
        return $this->callServer("helper/search-campaigns", $params);
    }

    function helperSearchMembers($query, $id, $offset) {
        $params = array();
        $params["query"] = $query;
        $params["id"] = $id;
        $params["offset"] = $offset;
        return $this->callServer("helper/search-members", $params);
    }


    function helperVerifiedDomains() {

        $params = array();
        return $this->callServer("helper/verified-domains", $params);
    }
     ...
     */
    function reportsAbuse($cid, $opts) {
        $params = array();
        $params["cid"] = $cid;
        $params["opts"] = $opts;
        return $this->callServer("reports/abuse", $params);
    }
     ...
     */
    function reportsAdvice($cid) {
        $params = array();
        $params["cid"] = $cid;
        return $this->callServer("reports/advice", $params);
    }
     ...
     */
    function reportsBounceMessage($cid, $email) {
        $params = array();
        $params["cid"] = $cid;
        $params["email"] = $email;
        return $this->callServer("reports/bounce-message", $params);
    }
     ...
     */
    function reportsBounceMessages($cid, $opts) {
        $params = array();
        $params["cid"] = $cid;
        $params["opts"] = $opts;
        return $this->callServer("reports/bounce-messages", $params);
    }
     ...
     */
    function reportsClickDetail($cid, $tid, $opts) {
        $params = array();
        $params["cid"] = $cid;
        $params["tid"] = $tid;
        $params["opts"] = $opts;
        return $this->callServer("reports/click-detail", $params);
    }
     ...
     */
    function reportsClicks($cid) {
        $params = array();
        $params["cid"] = $cid;
        return $this->callServer("reports/clicks", $params);
    }
     ...
     */
    function reportsDomainPerformance($cid) {
        $params = array();
        $params["cid"] = $cid;
        return $this->callServer("reports/domain-performance", $params);
    }
    ...
    array lines containing detail of the order - product, category, quantity, item cost
     */
    function reportsEcommOrders($cid, $opts) {
        $params = array();
        $params["cid"] = $cid;
        $params["opts"] = $opts;
        return $this->callServer("reports/ecomm-orders", $params);
    }
     ...
     */
    function reportsEepUrl($cid) {
        $params = array();
        $params["cid"] = $cid;
        return $this->callServer("reports/eepurl", $params);
    }
     ...
     */
    function reportsGeoOpens($cid) {
        $params = array();
        $params["cid"] = $cid;
        return $this->callServer("reports/geo-opens", $params);
    }
     ...
     */
    function reportsGoogleAnalytics($cid) {
        $params = array();
        $params["cid"] = $cid;
        return $this->callServer("reports/google-analytics", $params);
    }


    function reportsMemberActivity($cid, $emails) {
        $params = array();
        $params["cid"] = $cid;
        $params["emails"] = $emails;
        return $this->callServer("reports/member-activity", $params);
    }
    ...
    string email Email address that opened the campaign
     */
    function reportsNotOpened($cid, $opts) {
        $params = array();
        $params["cid"] = $cid;
        $params["opts"] = $opts;
        return $this->callServer("reports/not-opened", $params);
    }
     ...
     */
    function reportsOpened($cid, $opts) {
        $params = array();
        $params["cid"] = $cid;
        $params["opts"] = $opts;
        return $this->callServer("reports/opened", $params);
    }


    function reportsSentTo($cid, $opts) {
        $params = array();
        $params["cid"] = $cid;
        $params["opts"] = $opts;
        return $this->callServer("reports/send-to", $params);
    }
     ...
     */
    function reportsShare($cid, $opts=array (
    )) {
        $params = array();
        $params["cid"] = $cid;
        $params["opts"] = $opts;
        return $this->callServer("reports/share", $params);
    }


    function reportsSummary($cid)
    {
        $params = array();
        $params["cid"] = $cid;
        return $this->callServer("reports/summary", $params);
    }
    ...
    string reason_text For unsubscribes only - if the reason is OTHER, the text entered.
     */
    function reportsUnsubscribes($cid, $opts = array()) {
        $params = array();
        $params["cid"] = $cid;
        $params["opts"] = $opts;
     ...
     */
    function templatesAdd($name, $html, $folder_id) {
        $params = array();
        $params["name"] = $name;
        $params["html"] = $html;
        $params["folder_id"] = $folder_id;
        return $this->callServer("templates/add", $params);
    }
     ...
     */
    function templatesDel($template_id) {
        $params = array();
        $params["template_id"] = $template_id;
        return $this->callServer("templates/del", $params);
    }
     ...
     */
    function templatesInfo($template_id, $type='user') {
        $params = array();
        $params["template_id"] = $template_id;
        $params["type"] = $type;
        return $this->callServer("templates/info", $params);
    }


    function templatesList($types, $filters) {
        $params = array();
        $params["types"] = $types;
        $params["filters"] = $filters;
        return $this->callServer("templates/list", $params);
    }
     ...
     * @return boolean true if the template was deleted, otherwise an error will be thrown
     */
    function templatesUndel($template_id) {
        $params = array();
        $params["template_id"] = $template_id;
        return $this->callServer("templates/undel", $params);
    }
     ...
     */
    function templatesUpdate($template_id, $values) {
        $params = array();
        $params["template_id"] = $template_id;
        $params["values"] = $values;
        return $this->callServer("templates/update", $params);
    }


    function usersInvite($email, $role, $msg)
    {
        $params = array();
        $params["email"] = $email;
        $params["role"] = $role;
        $params["msg"] = $msg;
        return $this->callServer("users/invite", $params);

    }

    function usersInviteResend($email)
    {
        $params = array();
        $params["email"] = $email;
        return $this->callServer("users/invite-resend", $params);

    }

    function usersInviteRevoke($email, $role, $msg)
    {
        $params = array();
        $params["email"] = $email;
        return $this->callServer("users/invite-revoke", $params);

    }

    function usersInvites()

    {
        $params = array();
        return $this->callServer("users/invites",$params);

    }


    function usersLoginRevoke($username)
    {
        $params = array();
        $params["username"] = $username;
        return $this->callServer("users/login-revoke", $params);
    ...
    {
        $params = array();
        return $this->callServer("users/logins", $params);
    ...
    {
        $params = array();
        return $this->callServer("vip/activity", $params);

    }

    function vipAdd($id, $emails)
    {
        $params = array();
        $params["id"] = $id;
        $params["emails"] = $emails;
        return $this->callServer("vip/add", $params);

    }

    function vipDel($id, $emails)
    {
        $params = array();
        $params["id"] = $id;
        $params["emails"] = $emails;
        return $this->callServer("vip/del", $params);
    ...
    {
        $params = array();
        return $this->callServer("vip/members", $params);
